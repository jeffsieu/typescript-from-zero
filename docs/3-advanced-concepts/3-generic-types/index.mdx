---
sidebar_label: 3.3. Generic types
---
...
Write a generic function `filterByProperty` that takes an array of objects and a property name, and returns an array of values for that property. Ensure the function is type-safe and works for any object type.

<CodeEditor codeKey="exercise3.3.1" defaultValue={Exercise3_1} solution={Exercise3_1_Solution} />
