---
sidebar_label: 3.2. Function overloading
---
...
Create a function `describe` that takes either a `string` or a `number` as input. If the input is a `string`, it should return the length of the string. If the input is a `number`, it should return the square of the number. Use function overloading to achieve this.

<CodeEditor codeKey="exercise3.2.1" defaultValue={Exercise2_1} solution={Exercise2_1_Solution} />
