...
Use `keyof` to extract the type of a property from an object type.

<CodeEditor codeKey="exercise3.1.1" defaultValue={Exercise1_1} solution={Exercise1_1_Solution} />
