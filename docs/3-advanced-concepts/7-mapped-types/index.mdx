---
sidebar_label: 3.7. Mapped types
---
...
Implement some utility types using mapped types.

<CodeEditor codeKey="exercise3.7.1" defaultValue={Exercise7_1} solution={Exercise7_1_Solution} />

## Exercise 7.2

import Exercise7_2 from '!!raw-loader!./exercise-7.2.ts';
import Exercise7_2_Solution from '!!raw-loader!./exercise-7.2.solution.ts';

Implement a type-safe event system using mapped types.

<CodeEditor codeKey="exercise3.7.2" defaultValue={Exercise7_2} solution={Exercise7_2_Solution} />
