---
sidebar_label: 3.6. Template literal types
---
...
Use template literal types to create a type that represents valid URLs.

<CodeEditor codeKey="exercise3.6.1" defaultValue={Exercise6_1} solution={Exercise6_1_Solution} />
